<%@ Page Title="Pengkajian Mutu Syrup" Language="VB" MasterPageFile="~/MasterPage/main.master" AutoEventWireup="false" CodeFile="PengkajianMutuSyr.aspx.vb" Inherits="QA_DataMaster_PengkajianMutuSyr" %>
...
<asp:ScriptManagerProxy ID="smProxy" runat="server">
    ...
    <div style="padding:2px;">
        <table border="0">
            ...
            <tr valign="middle">
                <td align="right">Spek Volume :</td>
                <td align="left">
                    <asp:TextBox ID="txtNettoVolumeSpek" Width="90" runat="server" />
                </td>
                <td></td>
                <td align="right">Hasil :</td>
                <td align="left">
                    <asp:TextBox ID="txtNettoVolumeHasil" Width="90" style="text-align:right" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="5" style="background-color:Silver; font-weight: bold; padding:10px">
                    Kapasitas Penetralan</td>
            </tr>
            <tr valign="middle">
                <td align="right">Spek :</td>
                <td align="left">
                    <asp:TextBox ID="txtPenetralanSpek" Width="120" runat="server" />
                </td>
                <td></td>
                <td align="right">Hasil :</td>
                <td align="left">
                    <asp:TextBox ID="txtPenetralanHasil" Width="90" style="text-align:right" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="5" style="background-color:Silver; font-weight: bold; padding:10px">
            ...
            <tr valign="middle">
                <td align="right">Spek :</td>
                <td align="left">
                    <asp:TextBox ID="txtDefoamingSpek" Width="120" runat="server" />
                </td>
                <td></td>
                <td align="right">Hasil :</td>
                <td align="left">
                    <asp:TextBox ID="txtDefoamingHasil" Width="90" style="text-align:right" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="5" style="background-color:Silver; font-weight: bold; padding:10px">
