...
Partial Class QA_DataMaster_PengkajianMutuTabNonSalut
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            oPengkajianMutu.SaveTabNonSalutHDR(structTabHdr)
            ClearControls()
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            oPengkajianMutu.DeleteTabHDR(txtProdID.Text, txtNoBatch.Text)
            ClearControls()
    ...
    Protected Sub btnHapus_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        btnHapusKadar.Click, btnHapusBobot.Click, btnHapusKandungan.Click, btnHapusDisolusi.Click
