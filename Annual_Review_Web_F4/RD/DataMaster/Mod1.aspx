<%@ Page Language="VB" MasterPageFile="~/MasterPage/main.master" AutoEventWireup="false" CodeFile="Mod1.aspx.vb" Inherits="QA_DataMaster_Mod1" title="Perubahan Batch Size" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding:2px;">
            ...
            <tr valign="middle">
             ...
             <tr valign="middle">
                ...
                <td align="left">
                    ...
                    <asp:RequiredFieldValidator ID="valUmurProduk" runat="server" ControlToValidate="txtUmurProduk" ValidationGroup="save" ErrorMessage="*" />
                    &nbsp; tahun  
                </td>
            </tr>
            <tr valign="middle">
        ...
        <div style="display: none">
            ...
            <asp:TextBox ID="orgUmurProduk" runat="server" EnableViewState="false" />
