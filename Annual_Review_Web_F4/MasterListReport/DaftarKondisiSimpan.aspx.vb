...
Partial Class MasterListReport_DaftarKondisiSimpan
    ...
    Protected Sub btnGetRpt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGetRpt.Click
        ...
        Try
            RptMasterList.LocalReport.ReportPath = "Report/DaftarKondisiSimpan.rdlc"

            dt = ds.GetMasterListDN(ItemCode, "5")
